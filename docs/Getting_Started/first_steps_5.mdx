---
id: first_steps_5
title: "Create a New SHAFT Test Automation Project"
sidebar_label: New Projects
description: "Set up a new SHAFT project in under 5 minutes. Use the interactive project generator or Maven archetype to get started with Web, Mobile, or API testing."
keywords: [create selenium project, new test automation project, maven archetype testing, shaft project generator, java test project setup]
tags: [getting-started, project-setup, maven]
---
...
:::tip
If the generator doesn't load above, you can [open it in a new tab](https://shafthq.github.io/SHAFT_ENGINE/shaft-engine/resources/).
:::
...
- You can do that by following this lovely **[IntelliJ IDEA guide]**.
  ...
  Version: 10.1.20260331
  ```
  :::info[**Replace**]
  `10.1.20260331` with **[the latest SHAFT_Engine: TestNG Archetype version](https://github.com/ShaftHQ/testng-archetype/releases/latest)**.
  :::
...
- Or you can do it manually by following these steps:
  ...
  4. Open a Terminal window in the target directory and execute the below command.
    ...
    mvn archetype:generate "-DarchetypeGroupId=io.github.shafthq" "-DarchetypeArtifactId=testng-archetype" "-DarchetypeVersion=10.1.20260331" "-DinteractiveMode=false" "-DgroupId=io.github.shafthq" "-DartifactId=using_SHAFT_Engine"
    ```
:::info[**Replace**]
`10.1.20260331` with **[the latest SHAFT_Engine: TestNG Archetype version](https://github.com/ShaftHQ/testng-archetype/releases/latest)**.
:::
...
|-------|------------------|
| **[Web Testing Setup →](./setup_web)** | Browser automation with TestNG, JUnit 5, or Cucumber |
| **[Mobile Testing Setup →](./setup_mobile)** | Android & iOS app automation with Appium |
| **[API Testing Setup →](./setup_api)** | REST API testing with request/response validation |
