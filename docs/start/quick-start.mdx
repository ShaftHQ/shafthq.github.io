...
![SHAFT IntelliJ Assistant first-run setup wizard with Prerequisites marked Done, Choose agent expanded on Select an option, then Setup tools and skills, Check agent connection, and Check tools installation](/img/agentic/intellij-plugin-mcp-setup.png)

Once **Check tools installation** passes, the wizard collapses the finished
...
![Completed SHAFT IntelliJ Assistant setup showing Check tools installation marked Done and a Ready row with Start without an agent](/img/agentic/intellij-plugin-mcp-setup-success.png)
