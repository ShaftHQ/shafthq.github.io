...
import {AndroidSetupCommands, LighthouseSetupCommands} from '@site/src/components/DocSnippets';
...
and `MOBILE_ANDROID`. Reporting uses SHAFT's pinned, SHA-256-verified portable
Node and adds Allure 3. Android uses the same portable Node owner and adds a
reviewed Android SDK, Appium project, emulator, and SHAFT-owned virtual device.
