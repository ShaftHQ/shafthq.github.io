...
<div className="doc-card-grid">
  ...
  <Link className="doc-card" to="/docs/agentic/intellij"><strong>IntelliJ coding partner</strong><span>Record, refactor, reuse Page Objects, diagnose failures, and call MCP from the IDE.</span></Link>
</div>
...
<GitHubStarLink /> before you leave the guide.
