...
import ScrollableTabs from '../../src/components/ScrollableTabs/ScrollableTabs.js';
...
<Tabs groupId="PropertyTypes">
  ...
  *The traditional way of configuring SHAFT properties, using this approach you can simply create your own `custom.properties` file.*
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <TabItem value="visuals" label="Visuals">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <TabItem value="healenium" label="Healenium">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <TabItem value="pattern" label="Pattern">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <TabItem value="tinkey" label="Tinkey">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <TabItem value="browserStack" label="BrowserStack">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <TabItem value="log4j" label="Log4j">
