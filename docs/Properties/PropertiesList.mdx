...
<Tabs groupId="PropertiesList">
    <CustomTabs value="platform" label="Platform">
  ...
  *The traditional way of configuring SHAFT properties, using this approach you can simply create your own `custom.properties` file.*
    ...
    <CustomTabs value="web" label="Web">
    ...
    *The traditional way of configuring SHAFT properties, using this approach you can simply create your own `custom.properties` file.*
    ...
    <CustomTabs value="mobile" label="Mobile">
    ...
    *The traditional way of configuring SHAFT properties, using this approach you can simply create your own `custom.properties` file.*
    ...
    <CustomTabs value="flags" label="Flags">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="reporting" label="Reporting">
   ...
   <details open>
    ...
    <CustomTabs value="timeouts" label="Timeouts">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="visuals" label="Visuals">
   ...
   <details open>
    ...
    <CustomTabs value="jira" label="Jira">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="cucumber" label="Cucumber">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="healenium" label="Healenium">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="paths" label="Paths">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="pattern" label="Pattern">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="tinkey" label="Tinkey">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="browserStack" label="BrowserStack">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="lambdaTest" label="LambdaTest">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="performance" label="Performance">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="testng" label="TestNG">
    ...
    *The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    ...
    <CustomTabs value="log4j" label="Log4j">
