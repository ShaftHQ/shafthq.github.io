...
<Tabs groupId="PropertyTypes">
    <TabItem value="platform" label="Platform">*The traditional way of configuring SHAFT properties, using this approach you can simply create your own `custom.properties` file.*
    <details open>
    ...
    <TabItem value="web" label="Web">*The traditional way of configuring SHAFT properties, using this approach you can simply create your own `custom.properties` file.*
     <details open>
    ...
    <TabItem value="mobile" label="Mobile">*The traditional way of configuring SHAFT properties, using this approach you can simply create your own `custom.properties` file.*
    ...
    <TabItem value="flags" label="Flags">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
     <details open>
    ...
    <TabItem value="reporting" label="Reporting">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
   <details open>
    ...
    <TabItem value="timeouts" label="Timeouts">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
     <details open>
    ...
    <TabItem value="visuals" label="Visuals">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
   <details open>
    ...
    <TabItem value="jira" label="Jira">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    <details open>
    ...
    <TabItem value="cucumber" label="Cucumber">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
     <details open>
    ...
    <TabItem value="healenium" label="Healenium">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
     <details open>
    ...
    <TabItem value="paths" label="Paths">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
     <details open>
    ...
    <TabItem value="pattern" label="Pattern">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    <details open>
    ...
    <TabItem value="tinkey" label="Tinkey">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    <details open>
    ...
    <TabItem value="browserStack" label="BrowserStack">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    <details open>
    ...
    <TabItem value="lambdaTest" label="LambdaTest">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    <details open>
    ...
    <TabItem value="performance" label="Performance">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    <details open>
    ...
    <TabItem value="testng" label="TestNG">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    <details open>
    ...
    <TabItem value="log4j" label="Log4j">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*
    <details open>
