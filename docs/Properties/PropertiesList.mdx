...
***Since version 8.3.20240813 Allure Reporting Properties Have Changed to The Following*** 

  <TabItem value="defaults" label="Default Values">

| Old Property Name                              |new Property Name | Default Value | Possible Values | Description |
| -----------------------------------------------| ---------------- | --------------| --------------- |-------------
| cleanAllureResultsDirectoryBeforeExecution     | accumulateHistory| `false`       | `true`, `false` | delete old results before the new run 
| generateAllureReportArchive                    | generateArchive  | `false`       | `true`, `false` | generate Archive File .Zip for generated Allure report
| openAllureReportAfterExecution                 | automaticallyOpen|`true`        | `true`, `false` | open allure report after execution
|                                                | accumulateReports|'true'        | `true`, `false` | by default keeps old html allure reports and if false it will keep only last run report
