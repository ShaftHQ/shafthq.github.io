...
<Tabs groupId="PropertyLists">
  <TabItem value="platform" label="Platform" onclick="showTabContent('platform')"></TabItem>
  <TabItem value="web" label="Web" onclick="showTabContent('web')"></TabItem>
  <!-- Add other TabItems here -->
</Tabs>

<details open id="configDetails">
  <summary>Platform Configuration</summary>
  <div class="tab-content" id="platformContent">
    <!-- Platform Configuration content -->
...
| enableBiDi              | `true`        | `true`, `false`                                                               | • To enable or disable the [WebDriver BiDi protocol](https://www.selenium.dev/documentation/webdriver/bidirectional/webdriver_bidi/).                                                                                                                                                                                                                                                                                                                                                                |
  ...
  <div class="tab-content" id="webContent">
    <!-- Web Configuration content -->
