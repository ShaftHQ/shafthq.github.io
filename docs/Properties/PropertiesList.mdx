...
<Tabs groupId="PropertiesList">
  ...
  <TabItem value="mobile" label="Mobile">*The traditional way of configuring SHAFT properties, using this approach you can simply create your own `custom.properties` file.*</TabItem>
  <TabItem value="flags" label="Flags">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="reporting" label="Reporting">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="timeouts" label="Timeouts">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="visuals" label="Visuals">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="jira" label="Jira">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="cucumber" label="Cucumber">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="healenium" label="Healenium">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="paths" label="Paths">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="pattern" label="Pattern">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="tinkey" label="Tinkey">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="browserStack" label="BrowserStack">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="lambdaTest" label="LambdaTest">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="performance" label="Performance">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="testng" label="TestNG">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
  <TabItem value="log4j" label="Log4j">*The default/preset values built into SHAFT, with a description of what each one does and the possible values.*</TabItem>
</Tabs>
...
<details open>
  <summary>Mobile Configuration</summary>
### Mobile
...
<Tabs groupId="PropertyTypes">
  <TabItem value="mobile-code-based" label="Code-based">
  ...
  <TabItem value="mobile-cli-based" label="CLI-based">
  ...
  <TabItem value="mobile-defaults" label="Default Values">
...
<Tabs groupId="PropertyTypes">
  <TabItem value="flags-code-based" label="Code-based">
  ...
  <TabItem value="flags-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="flags-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="flags-defaults" label="Default Values">
...
<Tabs groupId="PropertyTypes">
  <TabItem value="reporting-code-based" label="Code-based">
  ...
  <TabItem value="reporting-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="reporting-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="reporting-defaults" label="Default Values">
...
<details open>
  <summary>Timeouts Configuration</summary>
### Timeouts
...
<Tabs groupId="PropertyTypes">
  <TabItem value="timeouts-code-based" label="Code-based">
  ...
  <TabItem value="timeouts-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="timeouts-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="timeouts-defaults" label="Default Values">
...
<details open>
  <summary>Visuals Configuration</summary>
### Visuals
...
<Tabs groupId="PropertyTypes">
  <TabItem value="visuals-code-based" label="Code-based">
  ...
  <TabItem value="visuals-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="visuals-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="visuals-defaults" label="Default Values">
...
<Tabs groupId="PropertyTypes">
  <TabItem value="jira-code-based" label="Code-based">
  ...
  <TabItem value="jira-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="jira-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="jira-defaults" label="Default Values">
...
<details open>
  <summary>Cucumber Configuration</summary>
### Cucumber
...
<Tabs groupId="PropertyTypes">
  <TabItem value="cucumber-code-based" label="Code-based">*(N/A)*</TabItem>
  <TabItem value="cucumber-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="cucumber-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="cucumber-defaults" label="Default Values">
...
<details open>
  <summary>Healenium Configuration</summary>
### Healenium

<Tabs groupId="PropertyTypes">
  <TabItem value="healenium-code-based" label="Code-based">*(Work In Progress)*</TabItem>
  <TabItem value="healenium-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="healenium-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="healenium-defaults" label="Default Values">
...
<details open>
  <summary>Paths Configuration</summary>
### Paths

<Tabs groupId="PropertyTypes">
  <TabItem value="paths-code-based" label="Code-based">*(Work In Progress)*</TabItem>
  <TabItem value="paths-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="paths-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="paths-defaults" label="Default Values">
...
<details open>
  <summary>Pattern Configuration</summary>
### Pattern

<Tabs groupId="PropertyTypes">
  <TabItem value="pattern-code-based" label="Code-based">*(Work In Progress)*</TabItem>
  <TabItem value="pattern-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="pattern-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="pattern-defaults" label="Default Values">
...
<details open>
  <summary>Tinkey Configuration</summary>
### Tinkey

<Tabs groupId="PropertyTypes">
  <TabItem value="tinkey-code-based" label="Code-based">*(Work In Progress)*</TabItem>
  <TabItem value="tinkey-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="tinkey-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="tinkey-defaults" label="Default Values">
...
<details open>
  <summary>BrowserStack Configuration</summary>
### BrowserStack

<Tabs groupId="PropertyTypes">
  <TabItem value="browserStack-code-based" label="Code-based">*(Work In Progress)*</TabItem>
  <TabItem value="browserStack-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="browserStack-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="browserStack-defaults" label="Default Values">
...
<details open>
  <summary>LambdaTest Configuration</summary>
### LambdaTest

<Tabs groupId="PropertyTypes">
  <TabItem value="lambdaTest-code-based" label="Code-based">*(Work In Progress)*</TabItem>
  <TabItem value="lambdaTest-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="lambdaTest-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="lambdaTest-defaults" label="Default Values">
...
<Tabs groupId="PropertyTypes">
  <TabItem value="performance-code-based" label="Code-based">*(Work In Progress)*</TabItem>
  <TabItem value="performance-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="performance-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="performance-defaults" label="Default Values">
...
<details open>
  <summary>TestNG Configuration</summary>
### TestNG
...
<Tabs groupId="PropertyTypes">
  <TabItem value="testng-code-based" label="Code-based">*(N/A)*</TabItem>
  <TabItem value="testng-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="testng-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="testng-defaults" label="Default Values">
...
<details open>
  <summary>Log4j Configuration</summary>
### Log4j
...
<Tabs groupId="PropertyTypes">
  <TabItem value="log4j-code-based" label="Code-based">*(N/A)*</TabItem>
  <TabItem value="log4j-cli-based" label="CLI-based">*(Work In Progress)*</TabItem>
  <TabItem value="log4j-file-based" label="File-based">*(Work In Progress)*</TabItem>
  <TabItem value="log4j-defaults" label="Default Values">
