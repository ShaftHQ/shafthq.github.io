...
- managed local AI inventory through `setup_status` and `setup_verify`;
  ...
  local-only, and the reviewed pin, storage class, update/cleanup policy, and
  deterministic fallback are documented in
