...
plugin, copy the matching installer command, then infer the local
`java @shaft-mcp.args` stdio command after installation. Manual paste remains
available in setup and settings.
