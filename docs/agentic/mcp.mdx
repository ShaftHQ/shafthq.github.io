...
never a Codex default), copy the matching Agentic Tools installer command, run
it in the IntelliJ terminal, then check the agent connection and the tools
installation and store the local stdio command automatically.
