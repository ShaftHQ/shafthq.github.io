---
id: history-rewrite
title: Repository history rewrite
description: Maintainer-only procedure for approved repository history rewrites.
slug: /maintainers/history-rewrite
tags: [maintainers, git]
---
...
- **Maintainer preservation strategy**: preserve full pre-flatten attribution
  in the unlisted [maintainer history manifest](/docs/archive/engine/contributors-history).
...
- Example measured results are retained in the
  [history rewrite validation record](/docs/archive/engine/history-rewrite-validation).
