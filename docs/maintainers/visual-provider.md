---
id: visual-provider
title: Visual provider boundary
description: Maintainer contract between shaft-engine and the optional visual provider.
slug: /maintainers/visual-provider
tags: [maintainers, visual]
---
