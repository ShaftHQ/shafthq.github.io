---
id: ci-failure-investigation
title: CI failure investigation
description: Diagnose SHAFT CI failures using workflow logs and Allure artifacts.
slug: /maintainers/ci-failure-investigation
tags: [maintainers, ci, allure]
---
