...
id: reactor
title: Maven reactor
description: SHAFT modules, compatibility artifacts, and build boundaries.
slug: /maintainers/reactor
tags: [maintainers, maven, architecture]
---
...
Consumer-facing method boundaries are documented in the
[upgrade guide](/docs/start/upgrade), with focused guides for SHAFT Heal,
BrowserStack, desktop video, and visual processing.

Deterministic element recovery, Healenium coexistence, privacy, and optional
visual/AI evidence are documented in [SHAFT Heal](/docs/agentic/heal).

MCP client configuration, transport behavior, and credential boundaries are
documented in [SHAFT MCP](/docs/agentic/mcp).

Pilot contracts, direct-provider configuration, approval, and redaction are
documented in [optional AI providers](/docs/agentic/providers).
...
are documented in [SHAFT Doctor](/docs/agentic/doctor).
