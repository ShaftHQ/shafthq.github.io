---
id: publication
title: Maven Central publication
description: SHAFT reactor publication order, verification, and rollback contract.
slug: /maintainers/publication
tags: [maintainers, release, maven-central]
---
