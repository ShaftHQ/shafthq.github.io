...
| maximumPerformanceMode                      | `0`           | `0`, `1`, `2`                            | • `0` → Disabled, `1` → Without Headless Execution, `2` → With Headless Execution <br/>• Enabling maximumPerformanceMode will disable all complementary features, including screenshot watermarking, to ensure the fastest execution possible with a 400% calculated performance boost.    |
