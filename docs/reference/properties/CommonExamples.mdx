...
sidebar_label: Common Examples
description: "Practical configuration examples for SHAFT Engine — web, mobile, API, parallel execution, cloud platforms, and CI/CD pipeline setup."
keywords: [SHAFT, configuration examples, web config, mobile config, API config, BrowserStack config, CI/CD config, parallel testing]
tags: [configuration, examples, properties]
---
...
[Local Selenium Grid Execution](/docs/reference/actions/GUI/didYouKnow/Local_Selenium_Grid_Execution)
guide.
:::
...
When enabled, maximum performance mode also disables screenshot watermarking to avoid image re-encoding overhead.
