...
description: "Learn about SHAFT Engine's built-in reports — Allure and Execution Summary — how to configure video recording and report behavior via properties, and how to add custom report messages and SHAFT.Report attachments."
keywords: [shaft reporting, allure report, execution summary, video recording, test report, ci cd report, custom report messages, withCustomReportMessage, SHAFT.Report, allure attachments]
tags: [reporting, allure, video, custom-report-messages]
---
...
## Custom report messages {/* #custom-report-messages */}
...
## SHAFT.Report programmatic API {/* #shaft-report-api */}
