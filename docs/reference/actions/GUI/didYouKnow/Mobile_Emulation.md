...
- [Properties List](/docs/reference/properties/PropertiesList) — full reference for all `web.*` properties
- [Cross-Platform Strategy](/docs/reference/guides/Cross_Platform_Strategy) — how to structure tests across desktop and mobile
