...
- [SHAFT Properties Reference](/docs/reference/properties/PropertiesList)
- [SHAFT Common Configuration Examples](/docs/reference/properties/CommonExamples)
- [Parallel Execution Guide](/docs/reference/configuration/parallelExecution)

:::tip
For production environments or cloud execution, consider a managed Grid
service. See the
[Common Examples](/docs/reference/properties/CommonExamples#example-4-browserstack-execution).
:::
