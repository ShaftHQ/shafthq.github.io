...
- [Parallel Execution](/docs/reference/configuration/parallelExecution) — Configure SHAFT for parallel test execution.
- [Properties List](/docs/reference/properties/PropertiesList) — Full reference for all SHAFT platform and execution properties.
