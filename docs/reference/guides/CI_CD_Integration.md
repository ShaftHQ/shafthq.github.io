...
Running your SHAFT tests in a CI/CD pipeline is straightforward. SHAFT's
[property system](/docs/reference/properties/PropertyTypes) lets you override
...
:::info
Remember the [property priority hierarchy](/docs/reference/properties/PropertyTypes):
**Code-based > CLI-based > File-based > Defaults**.
:::
