...
[quick-start guide](/docs/start/quick-start), and a fluent API designed for
readability.
...
SHAFT is [open-source on GitHub](https://github.com/ShaftHQ/SHAFT_ENGINE) with
active development and [community support](/docs/start/overview).
