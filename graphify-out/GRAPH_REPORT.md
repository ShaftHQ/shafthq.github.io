...
## Corpus Check
- 225 files · ~319,240 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2406 nodes · 2409 edges · 233 communities (204 shown, 29 thin omitted)
...
## Knowledge Gaps
- **1575 isolated node(s):** `startTime`, `documentation`, `githubContext`, `keyTopics`, `apiDocStart` (+1570 more)
...
- **Why does `fetch()` connect `Community 225` to `static/img (5)`, `Community 228`?**
