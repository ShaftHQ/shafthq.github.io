---
slug: release-10.3.20260713
title: "🚀 SHAFT 10.3.20260713: What's New and Why You Should Upgrade Today"
authors: [autobot]
...
👉 [View the full release on GitHub](https://github.com/ShaftHQ/SHAFT_ENGINE/releases/tag/10.3.20260713)
...
* feat: assistant slash commands — replay-proven /codegen, trust-ranked /doctor, timeline UX, MCP tool caching (closes #3494) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3505
...
* feat: Capture overlay P0 clarity & trust — status pills, steps wording, stop-confirm CTA, suppression transparency (#3496 P0) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3508
* feat: Capture overlay P1 authoring ergonomics — draggable panel, step badges, undo delete, help sheet, IDE parity (#3496 P1) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3509
...
* feat: Allure assertion evidence card — redacted expected/actual/diff per validation (#3502 A+B) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3515
* feat: unified SHAFT report theming — palette drift-guard, SHAFT categories, branded overview (#3504 P0/P1) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3522
* feat(validation): matchesScreenshot() executes immediately — no perform() required by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3524
