---
slug: release-10.3.20260716
title: "🚀 SHAFT 10.3.20260716: What's New and Why You Should Upgrade Today"
authors: [autobot]
...
A fresh release just dropped and it's packed with improvements you don't want to miss. **SHAFT 10.3.20260716** is here, and whether you're a seasoned SHAFT user or just getting started, there's something in this release for you.
...
👉 [View the full release on GitHub](https://github.com/ShaftHQ/SHAFT_ENGINE/releases/tag/10.3.20260716)
...
## What's Changed
* IntelliJ plugin: onboarding/setup/Assistant trust polish (#3601 prioritized top 5) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3602
* IntelliJ plugin: onboarding/setup/Assistant trust polish (#3601 remaining scope) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3604
* IntelliJ plugin: A5 tool-result disclosure, #3603 a11y sweep, /work-github skill by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3607
* Investigate reported IntelliJ plugin crash: platform bug, not shaft-intellij by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3608
* fix(intellij): get ShaftPluginUpgradeActivity off the startup coroutine dispatcher (marketplace release blocker) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3609
* IntelliJ plugin: remaining setupStatusLabel/testStatus-style accessible-description sweep (#3605) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3610
* Agent-guidance token audit: restructure test-driven-development skill (#3606) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3612
...
**Full Changelog**: https://github.com/ShaftHQ/SHAFT_ENGINE/compare/10.3.20260715...10.3.20260716
