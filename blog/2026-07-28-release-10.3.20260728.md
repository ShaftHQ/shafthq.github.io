---
slug: release-10.3.20260728
title: "🚀 SHAFT 10.3.20260728: What's New and Why You Should Upgrade Today"
authors: [autobot]
...
A fresh release just dropped and it's packed with improvements you don't want to miss. **SHAFT 10.3.20260728** is here, and whether you're a seasoned SHAFT user or just getting started, there's something in this release for you.
...
👉 [View the full release on GitHub](https://github.com/ShaftHQ/SHAFT_ENGINE/releases/tag/10.3.20260728)
...
## What's Changed
* docs: fix inaccurate facts and converge the root entry docs by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4295
* docs: converge the modular-era feature catalog (774 -> 514 lines) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4296
* memory: record docs-verification learnings from the root docs quality pass by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4297
* Upgrade CODE_OF_CONDUCT.md to Contributor Covenant v2.1 by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4298
* Fix SafariDriver accessible-name catch and native <select> tag-name case sensitivity by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4301
* Add IntelliJ SHAFT capture-demo scaffolding: reset-scripted demo project, local-scope Windows-MCP installer, runbook by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4302
* Wire FlutterTest.java into the Android_Native_BrowserStack nightly job by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4303
* Fix #4304: shorten 2 overlong .memory/memory/gotchas id pairs by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4305
* test: migrate MultipleElementsFailureTest off data: URL to TestPageServer by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4309
* test: drop dead ${HIDDEN} placeholder and unused button/script in NoSuchElementFailureTest by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4312
* Fix #4308: revert unverified FlutterTest enablement in Android_Native_BrowserStack nightly by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4315
* Fix #4311: capture_api_generate dropped codeBlocks on UNCONFIRMED status by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4317
* memory: record gotcha -- subagent sessions get gh pr merge --auto blocked by classifier by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4323
* Group current-agent label + settings gear into one chip in ShaftAssistantPanel routeRow by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4320
* Fix #4319: local-agent approval selector never showed, final answer duplicated by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4324
* Fix #4314: installer wizard polish pass (dead copy, agent check, merged buttons, recheck icon, blank Next badge) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4325
* Fix #4313: build a correctly-wired Flutter demo app in CI for Android_Native_BrowserStack by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4329
* Group current-agent label + configure gear into one chip in ShaftSettingsConfigurable by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4330
* memory: mark Flags gotcha resolved by PR #4331 by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4333
* Fixes #4328: reset Flags to pristine snapshot at test-class boundaries by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4331
* Fix #4321: self-heal MultipleElementsFoundException when exactly one match is actionable by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4326
* Wire MultipleElementsFailureTest into pr-gate.yml's shaft-engine unit-tests step by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4337
* Fixes #4334 by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4338
* memory: record TouchActions AssertionError vs RuntimeException gotcha by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4342
* Fixes #4332: last-resort disambiguation for touch/tap's identifyUniqueElement path by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4340
* Fixes #4327 by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4343
* Fixes #4341: ElementActionsHelper.failAction throws RuntimeException, not AssertionError by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4344
* Fixes #4339: wire TouchMultipleElementsFailureTest and LazyLoadingFixtureLiveTest into pr-gate.yml by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4345
* Optimize memory subsystem: prune 22 dead entries, SessionStart memory nudge, delete-over-stale-mark policy by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4347
* Record gotcha: Agent tool isolation:worktree worktrees the orchestrator repo by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4348
* Merge 6 findings from the 22-community-skills integration scan by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/4351


**Full Changelog**: https://github.com/ShaftHQ/SHAFT_ENGINE/compare/10.3.20260727...10.3.20260728
