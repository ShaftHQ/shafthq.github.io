---
slug: release-10.3.20260711
title: "🚀 SHAFT 10.3.20260711: What's New and Why You Should Upgrade Today"
authors: [autobot]
...
A fresh release just dropped and it's packed with improvements you don't want to miss. **SHAFT 10.3.20260711** is here, and whether you're a seasoned SHAFT user or just getting started, there's something in this release for you.
...
👉 [View the full release on GitHub](https://github.com/ShaftHQ/SHAFT_ENGINE/releases/tag/10.3.20260711)
...
## What's Changed
* SHAFT Assistant: pin engine warm-up version, fix codegen-after-recording dead end, retire '+' button for a filtered slash menu by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3420
* Solidify IntelliJ plugin guided workflows: live web/mobile recorder codegen + doctor runs, capture codegen fixes by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3421
* Fix RestActions JSON request bodies to honor Jackson annotations (Part of #3412) by @Mochxd in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3423
* Guided-workflow follow-ups: recorder/codegen/doctor enhancements, plugin UX polish, drift resilience (closes #3422) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3424
* IntelliJ plugin trustworthy first contact + onboarding/review-loop/differentiation follow-ups (#3426, #3425) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3427
* First-time-user trust pass: project-scoped MCP workspace, intent-first Assistant, no dead ends by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3428
* Add act-as-fable skill encoding Fable 5's working methodology by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3430
* IntelliJ plugin expert quality pass: recorder lifetime, codegen wedge, assistant UX (closes #3429) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/3431


**Full Changelog**: https://github.com/ShaftHQ/SHAFT_ENGINE/compare/10.3.20260710...10.3.20260711
