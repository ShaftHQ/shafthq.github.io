---
slug: release-10.2.20260610
title: "🚀 SHAFT 10.2.20260610: What's New and Why You Should Upgrade Today"
authors: [autobot]
...
A fresh release just dropped and it's packed with improvements you don't want to miss. **SHAFT_ENGINE 10.2.20260610** is here, and whether you're a seasoned SHAFT user or just getting started, there's something in this release for you.

<!-- truncate -->

## ⚡ What Changed?

- Auto-generated release notes are included below. Users upgrading from SHAFTENGINE should read the modular SHAFT upgrade guide.
- chore(deps): bump multiple stable dependencies (Cucumber components, Google libs, BrowserStack, GraalVM, JaCoCo) by @MohabMohie in https://github.com/ShaftHQ/SHAFTENGINE/pull/2807
- codex: add aggregate JaCoCo and reactor quality support by @MohabMohie in https://github.com/ShaftHQ/SHAFTENGINE/pull/2833
- Shaft modularization by @MohabMohie in https://github.com/ShaftHQ/SHAFTENGINE/pull/2839
- codex: fix Maven Central aggregate SBOM signing by @MohabMohie in https://github.com/ShaftHQ/SHAFTENGINE/pull/2840

👉 [View the full release on GitHub](https://github.com/ShaftHQ/SHAFT_ENGINE/releases/tag/10.2.20260610)
...
## What's Changed
* chore(deps): bump multiple stable dependencies (Cucumber components, Google libs, BrowserStack, GraalVM, JaCoCo) by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/2807
* codex: add aggregate JaCoCo and reactor quality support by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/2833
* Shaft modularization by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/2839
* codex: fix Maven Central aggregate SBOM signing by @MohabMohie in https://github.com/ShaftHQ/SHAFT_ENGINE/pull/2840


**Full Changelog**: https://github.com/ShaftHQ/SHAFT_ENGINE/compare/10.2.20260605...10.2.20260610
