...
const evidence = [
  ...
  {title: 'Visual evidence belongs with the result', body: 'Review visual validation alongside the execution record.', image: '/img/evidence/allure-visual-diff-evidence.png', alt: 'Real SHAFT Capture assertion workspace used to create test evidence.'},
];
...
const sponsors = [
  ...
  ['LambdaTest / TestMu', 'https://www.lambdatest.com/'],
...
export default function Home(): JSX.Element {
  return <Layout title="SHAFT Engine" description="Release decisions backed by inspectable test evidence.">
    <main data-testid="landing-main">
      ...
      <section className={`${styles.section} ${styles.proofBand}`} data-testid="landing-proof"><div className="container"><Heading as="h2">For researchers, stakeholders, and engineers</Heading><div><p><strong>Inspectable</strong> artifacts make results easier to review.</p><p><strong>Reproducible</strong> workflows retain test context with evidence.</p><p><strong>Open source</strong> means the implementation and history can be examined.</p></div></div></section>
